...
<body class="goto-here">
	...
	<section class="ftco-section">
		<div id="over" class="container">
			<p class="text-center">
				Siêu thị hạt giống (VINASEED) TP HCM, cung cấp hạt giống hoa, rau củ quả Toàn Quốc.
				<br>
				Quý khách hàng sẽ được lựa chọn loại hạt giống ưa thích để trồng tại Siêu thị hạt giống VINASEED.
				<br>
				Siêu thị hạt giống nhập từ Nga, Mỹ, hạt giống chất lượng, tỉ lệ hạt nảy mầm cao, kháng bệnh tốt.
				<br>
				CÔNG TY TNHH HẠT GIỐNG VINASEED
				<br>
				Giấy Phép ĐKKD số: ***.****.****
				<br>
				Do Sở KHĐT TPHCM cấp ngày 11/11/2021
			</p>
		</div>
	</section>
					...
					<div class="ftco-footer-widget mb-4">
						...
						<div class="d-flex">
							<ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
								<li><a href="#" class="py-2 d-block">Hình thức thanh toán</a></li>
								<li><a href="#" class="py-2 d-block">Chính sách đổi trả sản phẩm</a></li>
								<li><a href="#" class="py-2 d-block">Vận chuyển, giao nhận</a></li>
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span
									class="text">97 Man Thiện, phường Hiệp Phú,
										quận 9, TPHCM</span></li>
